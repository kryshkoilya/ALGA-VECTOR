...
portable-сборкой ALGA VECTOR 0.7.0 для Windows x64. Он не заменяет тексты
...
| Компонент | Версия в проверенной сборке 0.7.0 | Лицензия по metadata/upstream | Назначение |
|---|---:|---|---|
