...
- Для стабильной эксплуатации используйте `0.7.0`; `1.0.0rc2` предназначен
  для приёмки target-centric интерфейса и новой модели целей.
...
Отдельные теги `v0.2.1`–`v0.6.1` намеренно не создаются: их привязка к
маркерному или более новому коммиту исходников создала бы GitHub source
archives с неверными исходниками ранних версий.
